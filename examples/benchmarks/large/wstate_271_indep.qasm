...
ry(-1.5002031475108493) q[199];
ry(-1.500378390011688) q[200];
ry(-1.500552333875118) q[201];
ry(-1.5007249950616297) q[202];
ry(-1.5008963892584348) q[203];
ry(-1.5010665318854546) q[204];
ry(-1.5012354381011468) q[205];
ry(-1.5014031228081777) q[206];
ry(-1.5015696006589458) q[207];
ry(-1.5017348860609592) q[208];
ry(-1.501898993182073) q[209];
ry(-1.5020619359555907) q[210];
ry(-1.5022237280852333) q[211];
ry(-1.5023843830499797) q[212];
ry(-1.5025439141087837) q[213];
ry(-1.5027023343051706) q[214];
ry(-1.5028596564717165) q[215];
ry(-1.5030158932344142) q[216];
ry(-1.5031710570169303) q[217];
ry(-1.5033251600447541) q[218];
ry(-1.5034782143492438) q[219];
ry(-1.5036302317715715) q[220];
ry(-1.5037812239665722) q[221];
ry(-1.5039312024064964) q[222];
ry(-1.5040801783846713) q[223];
ry(-1.5042281630190728) q[224];
ry(-1.5043751672558106) q[225];
ry(-1.504521201872529) q[226];
ry(-1.504666277481726) q[227];
ry(-1.504810404533993) q[228];
ry(-1.5049535933211755) q[229];
ry(-1.505095853979462) q[230];
ry(-1.5052371964923965) q[231];
ry(-1.5053776306938216) q[232];
ry(-1.5055171662707518) q[233];
ry(-1.5056558127661819) q[234];
ry(-1.5057935795818265) q[235];
ry(-1.5059304759807983) q[236];
ry(-1.5060665110902247) q[237];
ry(-1.5062016939038039) q[238];
ry(-1.506336033284301) q[239];
ry(-1.5064695379659905) q[240];
ry(-1.50660221655704) q[241];
ry(-1.5067340775418425) q[242];
ry(-1.5068651292832949) q[243];
ry(-1.5069953800250253) q[244];
ry(-1.5071248378935722) q[245];
ry(-1.5072535109005132) q[246];
ry(-1.507381406944548) q[247];
ry(-1.5075085338135348) q[248];
ry(-1.5076348991864819) q[249];
ry(-1.5077605106354968) q[250];
ry(-1.5078853756276909) q[251];
ry(-1.508009501527045) q[252];
ry(-1.5081328955962325) q[253];
ry(-1.5082555649984053) q[254];
ry(-1.5083775167989393) q[255];
ry(-1.5084987579671445) q[256];
ry(-1.5086192953779378) q[257];
ry(-1.50873913581348) q[258];
ry(-1.5088582859647786) q[259];
ry(-1.5089767524332576) q[260];
ry(-1.5090945417322932) q[261];
ry(-1.5092116602887178) q[262];
ry(-1.5093281144442936) q[263];
ry(-1.509443910457154) q[264];
ry(-1.509559054503217) q[265];
ry(-1.5096735526775678) q[266];
ry(-1.5097874109958154) q[267];
ry(-1.5099006353954185) q[268];
ry(-1.5100132317369868) q[269];
x q[270];
cz q[270],q[269];
ry(1.5100132317369868) q[269];
cz q[269],q[268];
