...
h q[45];
h q[46];
cp(0.20474534392154123) psi[0],q[0];
cp(0.40949068784308246) psi[0],q[1];
cp(0.8189813756861649) psi[0],q[2];
cp(1.6379627513723298) psi[0],q[3];
cp(-3.0072598044349266) psi[0],q[4];
cp(0.2686656983097334) psi[0],q[5];
cp(0.5373313966194668) psi[0],q[6];
cp(1.0746627932389337) psi[0],q[7];
cp(2.1493255864778673) psi[0],q[8];
cp(-1.984534134223852) psi[0],q[9];
cp(2.314117038731882) psi[0],q[10];
cp(-1.6549512297158215) psi[0],q[11];
cp(2.973282847747943) psi[0],q[12];
cp(-0.3366196116837003) psi[0],q[13];
cp(-0.6732392233674006) psi[0],q[14];
cp(-1.3464784467348012) psi[0],q[15];
cp(-2.6929568934696024) psi[0],q[16];
cp(0.8972715202403814) psi[0],q[17];
cp(1.7945430404807627) psi[0],q[18];
cp(-2.6940992262180607) psi[0],q[19];
cp(0.8949868547434644) psi[0],q[20];
cp(1.7899737094869288) psi[0],q[21];
cp(-2.7032378882057286) psi[0],q[22];
cp(0.8767095307681287) psi[0],q[23];
cp(1.7534190615362575) psi[0],q[24];
cp(-2.7763471841070713) psi[0],q[25];
cp(0.7304909389654439) psi[0],q[26];
cp(1.4609818779308879) psi[0],q[27];
cp(2.9219637558617757) psi[0],q[28];
cp(-0.43925779545603444) psi[0],q[29];
cp(-0.8785155909120689) psi[0],q[30];
cp(-1.7570311818241378) psi[0],q[31];
cp(2.7691229435313107) psi[0],q[32];
cp(-0.7449394201169645) psi[0],q[33];
cp(-1.489878840233929) psi[0],q[34];
cp(-2.979757680467858) psi[0],q[35];
cp(0.3236699462438703) psi[0],q[36];
cp(0.6473398924877406) psi[0],q[37];
cp(1.2946797849754812) psi[0],q[38];
cp(2.5893595699509624) psi[0],q[39];
cp(-1.1044661672776617) psi[0],q[40];
cp(-2.2089323345553233) psi[0],q[41];
cp(1.8653206380689396) psi[0],q[42];
